...
-   Natural language grammar:
    -   Defines components of a sentence (verb, noun, ...) and rules how
        to combine them
    -   Does not advise on the choice between synonymous words or
        whether a sentence is meaningful; one can write grammatically
        correct nonsense
-   Graphics grammar:
    -   Defines components of a statistical graph and rules how to
        combine them
...
-   Grammar helps expressing ideas or information in a clear and
    coherent way
:::
...
-   [Geometic objects]{style="color:red;"}: what you see on the plot
    (points, lines, bars)

-   [Aesthetic attributes]{style="color:red;"}: "role" of variables in
    plot: location (often along x-axis and y-axis), colour, size, shape
...
-   [Scales]{style="color:red;"}: map data values to aesthetic
    attributes
