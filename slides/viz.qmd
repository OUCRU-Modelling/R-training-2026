...
The theme and styling of this presentation were created by a quantised Qwen3.6-35B-A3B model, ran fully local on 12GB VRAM and 32GB RAM
...
::: {.column width="50%"}
Which [aesthetic]{style="color: red;"} should we map these information to?

-   Country name [(label)]{.fragment style="color: red;"} 
-   Coverage, Inequality [(x, y)]{.fragment style="color: red;"} 
-   Population [(point size)]{.fragment style="color: red;"} 
-   Region [(color)]{.fragment style="color: red;"} 
