...
format:
  revealjs:
    ...
    theme: [solarized, intro-theme.scss]
    preview-links: true
    transition: fade
...
::: {.fragment}
- [Graphical User
Interface](https://r4stats.com/articles/software-reviews/r-gui-comparison/)
...
- Most often rectangular format
  - Columns: variables
  - Rows: observations
- Example: [titanic3](https://hbiostat.org/data/repo/ctitanic3){preview-link="false" target="_blank"} data set; passenger
  characteristics and survival status after disaster with the [Titanic cruise ship](https://www.encyclopedia-titanica.org/){preview-link="false" target="_blank"}
...
2. RStudio: **Environment** pane: **Import Dataset**; or via **File** menu: **Import Dataset** 
   ...
   - see [Importing Data with
     RStudio](https://support.posit.co/hc/en-us/articles/218611977-Importing-Data-with-RStudio){preview-link="false" target="_blank"}
   - Imported as a ["tibble"](https://github.com/tidyverse/tibble){preview-link="false" target="_blank"}
    (enhancement of `data.frame`)
3. Database: [Oracle, SQLite, ...](https://solutions.posit.co/connections/db/databases/)
...
Data found here: [Titanic3.xlsx](https://github.com/OUCRU-Modelling/R-training-2025/raw/refs/heads/main/slides/data/Titanic3.xlsx){preview-link="false" target="_blank"}
...
- [Good introduction to factors](https://www.gormanalysis.com/blog/r-introduction-to-factors-tutorial)
...
- [A Comprehensive Introduction to Handling Date &
  Time](https://blog.rsquaredacademy.com/handling-date-and-time-in-r){preview-link="false"
  target="_blank"}
...
Return to [main course page](https://oucru-modelling.github.io/R-training-2026/){preview-link="false"
  target="_blank"}
