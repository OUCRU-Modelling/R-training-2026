...
- Exercises:
  ...
  - Datasets: 
    - {{< downloadthis slides/data/NightingaleRose.csv dname="Nightingale Rose" label="Data Nightingale Rose (csv file)" type="primary" >}}
    - {{< downloadthis slides/data/ICUcost.csv dname="ICU cost" label="Data ICU cost (csv file)" type="primary" >}}
