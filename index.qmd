...
Please follow this [precourse handout](handouts/precourse_setup.qmd){target="_blank"} to setup R and RStudio.
...
- [Lecture slides](slides/IntroductionRDay1.qmd){target="_blank"}
- **Learning objectives**:
...
- Exercises:
  - [Exercises](handouts/exercises_Day1.qmd){target="_blank"}
  - [Exercise answers](handouts/exercises_Day1_answer.qmd){target="_blank"}
...
- [Exercises](handouts/exercise_day3.qmd){target="_blank"}
